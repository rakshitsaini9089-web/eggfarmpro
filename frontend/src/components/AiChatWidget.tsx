  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 rounded-full bg-gradient-to-br from-primary via-green-600 to-primary-dark hover:from-primary-dark hover:to-primary-x-dark shadow-lg z-50 flex items-center justify-center transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 border-2 border-gray-200 dark:border-white/20"
