...
A complete full-stack web application for managing an egg farm business with features for client management, sales tracking, payment processing, expense management, chick vaccination scheduling, and OCR-based payment verification.
...
- **Tesseract.js** - OCR processing for payment screenshots
