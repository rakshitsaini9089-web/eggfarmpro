...
router.post("/scan", upload.single("file"), async (req, res) => {
  ...
  try {
    ...
    console.log('FINAL EXTRACTED AMOUNT type:', typeof amount);
    console.log('FINAL EXTRACTED AMOUNT value:', amount);
    ...
    console.log('Response amount type:', typeof response.amount);
    console.log('Response amount value:', response.amount);
